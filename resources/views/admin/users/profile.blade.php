            ...
            <div class="col">
                <div class="card card-small mb-4">
                    <div class="card-header border-bottom">
                        <h6 class="m-0">Thêm thành viên</h6>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" class="form-control" id="phone_number"
                                                                placeholder="Email" name="phone_number" value="{{ $user->phone_number }}">
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                            <label for="fePassword">Password</label>
                                                            <input type="password" class="form-control" value="{{ $user->password }}" id="fePassword"
